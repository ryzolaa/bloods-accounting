<?php
    ...
    require_once('../_require/shop.php');
...
<body>
    ...
    <div class="adminCardBox">
        ...
        <div class="adminCard">
            <h5 class="adminCardTitle">Prix boutique</h5>
            <p>Modifier les prix de la boutique du site.</p>
            <ul class="list-group list-group-flush">
                <li class=" cardComponent"></li>
                <li class="cardComponentText">Coins: <?=$coin1?> | Price: <?=$price1?></li>
                <li class=" cardComponent"></li>
                <li class=" cardComponentText">Coins: <?=$coin2?> | Price: <?=$price2?></li>
                <li class=" cardComponent"></li>
                <li class="cardComponentText">Coins: <?=$coin3?> | Price: <?=$price3?></li>
                <li class=" cardComponent"></li>
                <li class=" cardComponentText">Coins: <?=$coin4?> | Price: <?=$price4?></li>
                <li class=" cardComponent"></li>
            </ul>
            <br>
            <div class="d-grid gap-2">
                <a href="_admin/coinEdit.php" class="btn btn-primary">Modifier les prix</a>
            </div>
        </div>
